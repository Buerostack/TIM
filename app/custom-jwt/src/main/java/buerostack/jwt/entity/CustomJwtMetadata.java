...
@Entity @Table(name="jwt_metadata", schema="custom") public class CustomJwtMetadata {
 ...
 public String getClaimKeys(){return claimKeys;} public void setClaimKeys(String v){this.claimKeys=v;}
 public Instant getIssuedAt(){return issuedAt;} public void setIssuedAt(Instant v){this.issuedAt=v;}
